...
<body>
    ...
    <form action="<?php echo U();?>" method="post" class="form-horizontal">
        ...
        <div class="form-item">
            ...
            <div class="controls">
                <input type="text" class="text input-large" name="idcard" value="">
            </div>
        </div>
        <div class="form-item">
        ...
        <div class="form-item">
            <label class="item-label">微信号码<span class="check-tips"></span></label>
            <div class="controls">
                <input type="text" class="text input-large" name="webchat" value="">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">常用地址<span class="check-tips"></span></label>
            <div class="controls">
        ...
        <div class="form-item">
            <label class="item-label">选择业务方向<span class="check-tips"></span></label>
            <div class="controls">
                <select class="select input-large" name="bdirection">
                    <?php if($data["bdirection"] == 0): ?><option value="0" selected="">左区</option> <?php else: ?> <option value="0">左区</option><?php endif; ?>
                    <?php if($data["bdirection"] == 1): ?><option value="1" selected="">中区</option> <?php else: ?> <option value="1">中区</option><?php endif; ?>
                    <?php if($data["bdirection"] == 2): ?><option value="2" selected="">右区</option> <?php else: ?> <option value="2">右区</option><?php endif; ?>
                </select>
